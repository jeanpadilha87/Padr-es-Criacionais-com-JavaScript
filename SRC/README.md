...
- Boleto
- Cartão de Crédito
O padrão Factory Method foi utilizado para desacoplar a criação dos objetos do restante do sistema. Dessa forma, o código principal não precisa conhecer diretamente as classes concretas de pagamento. Se futuramente for necessário adicionar uma nova forma de pagamento, como criptomoeda, basta criar uma nova classe e adicioná-la na fábrica, sem alterar o restante do sistema. Isso torna o projeto mais organizado, flexível e fácil de manter.
...
Pedido {
  itens: [ 'Mouse Gamer', 'Teclado Mecânico' ],
